package com.luixtech.sso.server.controller.advice;
...
public class ExceptionTranslatorAdvice {
    ...
    // todo: UnknownAccountException,IncorrectCredentialsException,LockedAccountException,AuthenticationException
    @ExceptionHandler(IncorrectCredentialsException.class)
    @ResponseBody
    public ResponseEntity<Result<Void>> handleIncorrectCredentialsException(IncorrectCredentialsException ex) {
    ...
    public String handleAuthorizationException(AuthorizationException ex, Model model) {
        // you could return a 404 here instead (this is how GitHub handles 403, so the user does NOT know there is a
        // resource at that location)
        log.warn("Failed to authorize: {}", ex.getMessage());
