...
public class UserAuthenticationEvent extends TableImpl<UserAuthenticationEventRecord> {
    ...
    /**
     * The reference instance of <code>luix-passport.user_authentication_event</code>
     */
    ...
    /**
     * The column <code>luix-passport.user_authentication_event.description</code>.
     */
    ...
    /**
     * Create an aliased <code>luix-passport.user_authentication_event</code> table reference
     */
    ...
    /**
     * Create a <code>luix-passport.user_authentication_event</code> table reference
     */
    ...
    @Override
    public List<UniqueKey<UserAuthenticationEventRecord>> getKeys() {
        return Arrays.<UniqueKey<UserAuthenticationEventRecord>>asList(Keys.KEY_USER_AUTHENTICATION_EVENT_PRIMARY);
    }
