...
public class SpringSessionAttributesRecord extends UpdatableRecordImpl<SpringSessionAttributesRecord> implements Record3<String, String, Long> {
     ...
     */
    public void setAttributeBytes(Long value) {
        set(2, value);
    }
    ...
    @Override
    public SpringSessionAttributesRecord value3(Long value) {
        setAttributeBytes(value);
        return this;
    }

    @Override
    public SpringSessionAttributesRecord values(String value1, String value2, Long value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public SpringSessionAttributesRecord(String sessionPrimaryId, String attributeName, Long attributeBytes) {
        super(SpringSessionAttributes.SPRING_SESSION_ATTRIBUTES);
