...
public class SpringSession extends TableImpl<SpringSessionRecord> {
    ...
    /**
     * The column <code>luix-passport.spring_session.MAX_INACTIVE_INTERVAL</code>.
     */
    ...
    /**
     * Create an aliased <code>luix-passport.spring_session</code> table reference
     */
    ...
    public List<UniqueKey<SpringSessionRecord>> getKeys() {
        return Arrays.<UniqueKey<SpringSessionRecord>>asList(Keys.KEY_SPRING_SESSION_PRIMARY, Keys.KEY_SPRING_SESSION_SESSION_ID);
    }
