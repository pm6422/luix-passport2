...
public class Tenant extends TableImpl<TenantRecord> {
    ...
    /**
     * The reference instance of <code>luix-passport.tenant</code>
     */
    ...
    /**
     * The column <code>luix-passport.tenant.id</code>.
     */
    public final TableField<TenantRecord, String> ID = createField(DSL.name("id"), SQLDataType.VARCHAR(30).nullable(false), this, "");
    ...
    /**
     * Create an aliased <code>luix-passport.tenant</code> table reference
     */
    ...
    /**
     * Create a <code>luix-passport.tenant</code> table reference
     */
    public Tenant() {
