...
public class UserRecord extends UpdatableRecordImpl<UserRecord> {
    ...
    /**
     * Setter for <code>luix-passport.user.verified_at</code>.
     */
    ...
    /**
     * Getter for <code>luix-passport.user.verified_at</code>.
     */
     ...
     */
    public UserRecord(String id, String username, String email, String mobileNo, String firstName, String lastName, String passwordHash, String activationCode, String verificationCode, LocalDateTime verifiedAt, String resetCode, LocalDateTime resetAt, Boolean profilePhotoEnabled, String remark, Boolean activated, Boolean enabled, LocalDateTime accountExpiresAt, LocalDateTime passwordExpiresAt, LocalDateTime lastSignInAt, String language, String createdBy, LocalDateTime createdAt, String modifiedBy, LocalDateTime modifiedAt, String locale, String timeZone, String dateFormat) {
        super(User.USER);
