...
public class UserAuthEvent implements Serializable {
    ...
    public UserAuthEvent(UserAuthEvent value) {
        this.id = value.id;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final UserAuthEvent other = (UserAuthEvent) obj;
        if (this.id == null) {
            if (other.id != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("UserAuthEvent (");
