...
public class UserAuthority extends TableImpl<UserAuthorityRecord> {
    ...
    /**
     * Create an aliased <code>luix-passport.user_authority</code> table reference
     */
    ...
    @Override
    public List<UniqueKey<UserAuthorityRecord>> getKeys() {
        return Arrays.<UniqueKey<UserAuthorityRecord>>asList(Keys.KEY_USER_AUTHORITY_PRIMARY);
    }

    @Override
    public List<ForeignKey<UserAuthorityRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<UserAuthorityRecord, ?>>asList(Keys.FK_USER_AUTHORITY_USER_ID);
    }
