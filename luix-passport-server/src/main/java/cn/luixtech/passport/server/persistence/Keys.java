...
public class Keys {
    ...
    public static final UniqueKey<TeamUserRecord> KEY_TEAM_USER_PRIMARY = Internal.createUniqueKey(TeamUser.TEAM_USER, DSL.name("KEY_team_user_PRIMARY"), new TableField[] { TeamUser.TEAM_USER.ID }, true);
