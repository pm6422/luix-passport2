...
public class Oauth2Authorization implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        else if (!authorizedScopes.equals(other.authorizedScopes))
            return false;
        if (attributes == null) {
            if (other.attributes != null)
                return false;
        }
        else if (!Arrays.equals(attributes, other.attributes))
            return false;
        if (state == null) {
            if (other.state != null)
                return false;
        ...
        else if (!Arrays.equals(authorizationCodeValue, other.authorizationCodeValue))
            return false;
        if (authorizationCodeIssuedAt == null) {
            if (other.authorizationCodeIssuedAt != null)
                return false;
        }
        else if (!authorizationCodeIssuedAt.equals(other.authorizationCodeIssuedAt))
            return false;
        if (authorizationCodeExpiresAt == null) {
            if (other.authorizationCodeExpiresAt != null)
                return false;
        }
        else if (!authorizationCodeExpiresAt.equals(other.authorizationCodeExpiresAt))
            return false;
        if (authorizationCodeMetadata == null) {
            if (other.authorizationCodeMetadata != null)
                return false;
        }
        else if (!Arrays.equals(authorizationCodeMetadata, other.authorizationCodeMetadata))
            return false;
        if (accessTokenValue == null) {
            if (other.accessTokenValue != null)
                return false;
        }
        else if (!Arrays.equals(accessTokenValue, other.accessTokenValue))
            return false;
        if (accessTokenIssuedAt == null) {
            if (other.accessTokenIssuedAt != null)
                return false;
        }
        else if (!accessTokenIssuedAt.equals(other.accessTokenIssuedAt))
            return false;
        if (accessTokenExpiresAt == null) {
            if (other.accessTokenExpiresAt != null)
                return false;
        }
        else if (!accessTokenExpiresAt.equals(other.accessTokenExpiresAt))
            return false;
        if (accessTokenMetadata == null) {
            if (other.accessTokenMetadata != null)
                return false;
        }
        else if (!Arrays.equals(accessTokenMetadata, other.accessTokenMetadata))
            return false;
        if (accessTokenType == null) {
            if (other.accessTokenType != null)
                return false;
        }
        else if (!accessTokenType.equals(other.accessTokenType))
            return false;
        if (accessTokenScopes == null) {
            if (other.accessTokenScopes != null)
                return false;
        }
        else if (!accessTokenScopes.equals(other.accessTokenScopes))
            return false;
        if (oidcIdTokenValue == null) {
            if (other.oidcIdTokenValue != null)
                return false;
        }
        else if (!Arrays.equals(oidcIdTokenValue, other.oidcIdTokenValue))
            return false;
        if (oidcIdTokenIssuedAt == null) {
            if (other.oidcIdTokenIssuedAt != null)
                return false;
        }
        else if (!oidcIdTokenIssuedAt.equals(other.oidcIdTokenIssuedAt))
            return false;
        if (oidcIdTokenExpiresAt == null) {
            if (other.oidcIdTokenExpiresAt != null)
                return false;
        }
        else if (!oidcIdTokenExpiresAt.equals(other.oidcIdTokenExpiresAt))
            return false;
        if (oidcIdTokenMetadata == null) {
            if (other.oidcIdTokenMetadata != null)
                return false;
        }
        else if (!Arrays.equals(oidcIdTokenMetadata, other.oidcIdTokenMetadata))
            return false;
        if (refreshTokenValue == null) {
            if (other.refreshTokenValue != null)
                return false;
        }
        else if (!Arrays.equals(refreshTokenValue, other.refreshTokenValue))
            return false;
        if (refreshTokenIssuedAt == null) {
            if (other.refreshTokenIssuedAt != null)
                return false;
        }
        else if (!refreshTokenIssuedAt.equals(other.refreshTokenIssuedAt))
            return false;
        if (refreshTokenExpiresAt == null) {
            if (other.refreshTokenExpiresAt != null)
                return false;
        }
        else if (!refreshTokenExpiresAt.equals(other.refreshTokenExpiresAt))
            return false;
        if (refreshTokenMetadata == null) {
            if (other.refreshTokenMetadata != null)
                return false;
        }
        else if (!Arrays.equals(refreshTokenMetadata, other.refreshTokenMetadata))
            return false;
        if (userCodeValue == null) {
            if (other.userCodeValue != null)
                return false;
        }
        else if (!Arrays.equals(userCodeValue, other.userCodeValue))
            return false;
        if (userCodeIssuedAt == null) {
            if (other.userCodeIssuedAt != null)
                return false;
        }
        else if (!userCodeIssuedAt.equals(other.userCodeIssuedAt))
            return false;
        if (userCodeExpiresAt == null) {
            if (other.userCodeExpiresAt != null)
                return false;
        }
        else if (!userCodeExpiresAt.equals(other.userCodeExpiresAt))
            return false;
        if (userCodeMetadata == null) {
            if (other.userCodeMetadata != null)
                return false;
        }
        else if (!Arrays.equals(userCodeMetadata, other.userCodeMetadata))
            return false;
        if (deviceCodeValue == null) {
            if (other.deviceCodeValue != null)
                return false;
        }
        else if (!Arrays.equals(deviceCodeValue, other.deviceCodeValue))
            return false;
        if (deviceCodeIssuedAt == null) {
            if (other.deviceCodeIssuedAt != null)
                return false;
        }
        else if (!deviceCodeIssuedAt.equals(other.deviceCodeIssuedAt))
            return false;
        if (deviceCodeExpiresAt == null) {
            if (other.deviceCodeExpiresAt != null)
                return false;
        }
        else if (!deviceCodeExpiresAt.equals(other.deviceCodeExpiresAt))
            return false;
        if (deviceCodeMetadata == null) {
            if (other.deviceCodeMetadata != null)
                return false;
        }
        else if (!Arrays.equals(deviceCodeMetadata, other.deviceCodeMetadata))
            return false;
        return true;
    }
