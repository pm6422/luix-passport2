...
[[requirements]]
== Requirements
Prior to building this project, it is necessary to install the Java Development Kit (JDK) on your machine. The JDK can be installed using https://sdkman.io/install[SDK Man].
