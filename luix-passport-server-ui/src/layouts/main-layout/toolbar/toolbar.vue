  ...
  <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
    ...
    >
      ...
      <div class="d-flex align-items-center gap-2 gap-lg-3">
        ...
        > -->
        <!--end::Primary button-->
        <button class="btn btn-sm fw-bold btn-light-primary" @click="$event => router.go(-1)">
          <span v-text="$t('form.global.back')"></span>
        </button>
      </div>
      <!--end::Actions-->
    </div>
...
import { toolbarWidthFluid } from "@/helpers/config";
